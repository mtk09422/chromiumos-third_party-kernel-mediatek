...
/*------ PDN Section -----------------------*/
#define PDN_FOR_UART1	0	/* MT_CG_PERI_UART0 */
#define PDN_FOR_UART2	0	/* MT_CG_PERI_UART1 */
#define PDN_FOR_UART3	0	/* MT_CG_PERI_UART2 */
#define PDN_FOR_UART4	0	/* MT_CG_PERI_UART3 */
