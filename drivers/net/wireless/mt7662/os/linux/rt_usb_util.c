...
UINT32 RtmpOsGetUsbDevManufacturerName(IN VOID *pUsbDev, IN UCHAR *pBuffer, IN UINT bufferLen){
	return usb_string(((struct usb_device *) pUsbDev), ((struct usb_device *) pUsbDev)->descriptor.iManufacturer, pBuffer, bufferLen);
}
...
UINT32 RtmpOsGetUsbDevProductName(IN VOID *pUsbDev, IN UCHAR *pBuffer, IN UINT bufferLen){
	return usb_string(((struct usb_device *) pUsbDev), ((struct usb_device *) pUsbDev)->descriptor.iProduct, pBuffer, bufferLen);
}
...
UINT32 RtmpOsGetUsbDevSerialNumber(IN VOID *pUsbDev, IN UCHAR *pBuffer, IN UINT bufferLen){
	return usb_string(((struct usb_device *) pUsbDev), ((struct usb_device *) pUsbDev)->descriptor.iSerialNumber, pBuffer, bufferLen);
}
#endif /* RTMP_MAC_USB */
