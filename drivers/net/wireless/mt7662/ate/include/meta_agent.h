 ...
 */
#if 0
#define MT_META_WIFI_TEST_GET_CMD_IDX(__idx, __cmd_idx)	\
	do{	\
		__cmd_idx = __idx & MT_META_WIFI_TEST_CMD_MASK; \
	}while(0)
#define MT_META_WIFI_TEST_GET_SET_IDX(__idx, __set_idx) \
	do{ \
		__set_idx = __idx & ~MT_META_WIFI_TEST_CMD_MASK;\
		__set_idx = __set_idx & MT_META_WIFI_TEST_SET_MASKL;\
	}while(0)
#endif
