...
#if 0
static VOID ACS_DumpChannelInfo(RTMP_ADAPTER *pAd)
{
    INT32 channel_idx = 0;
    PCHANNELINFO pChannelInfo = pAd->pChannelInfo;

    DBGPRINT(RT_DEBUG_TRACE, ("=========== Dump ACS Channel Info =========\n"));
    DBGPRINT(RT_DEBUG_TRACE, ("  Ch | Dirtiness  FalseCCA"
//#ifdef AP_QLOAD_SUPPORT
#if 0
        "  BusyTime"
#endif
    ...
    for (channel_idx = 0; channel_idx < pAd->ChannelListNum; channel_idx++)
    {
        DBGPRINT(RT_DEBUG_TRACE, ("[%3d]| %5lu        %5u"
//#ifdef AP_QLOAD_SUPPORT
#if 0
                                   "       %5u\n"
#endif
...
#if 0
static VOID ACS_DumpSortList(ACS_SORT_ENTRY *list, INT32 list_len)
{
    INT32 jj = 0;
    if (!list || !list_len)
        return;
 ...
 */
#if 0
static VOID AutoChannelSelCheck(RTMP_ADAPTER *pAd)
{
