...
typedef struct _WOW_CFG_STRUCT {
	...
	UINT32			TcpPortV4[64];	/* IPv4 TCP port for wake up packet */
	UINT8			TcpPortCntV4;		/* Number of IPv4 TCP port */
	UINT32			TcpPortV6[64];	/* IPv6 TCP port for wake up packet */
	UINT8			TcpPortCntV6;		/* Number of IPv6 TCP port */
	UINT32			UdpPortV4[64];	/* IPv4 UDP port for wake up packet */
	UINT8			UdpPortCntV4;		/* Number of IPv4 UDP port */
	UINT32			UdpPortV6[64];	/* IPv6 UDP port for wake up packet */
...
#ifdef MULTI_URB
	NDIS_SPIN_LOCK SubmitBulkInLock;	/* ReadBulkIn spinlock for index of reading next urb */ //chia-chi
	NDIS_SPIN_LOCK ReadBulkInLock;	/* ReadBulkIn spinlock for index of reading next urb */ //chia-chi
#endif
...
INT Set_Hw_Antenna_Div_Proc(RTMP_ADAPTER *pAd, PSTRING arg);
#endif /* RT5350 */
...
UCHAR RTMP_GetCustomizedChannelBw(
	IN PRTMP_ADAPTER pAd,
	IN UCHAR Channel);
...
#endif /* RT_CFG80211_SUPPORT */
#if defined(RT5370) || defined(RT5372) || defined(RT5390) || defined(RT5392)
INT Set_BbpResetFlagCountVale(RTMP_ADAPTER *pAd, PSTRING arg);
#endif /* defined(RT5370) || defined(RT5372) || defined(RT5390) || defined(RT5392) */
...
#if defined(RT2883) || defined(RT3883) || defined(RT3593)
INT Set_PhyRateLimit_Proc(RTMP_ADAPTER *pAd, PSTRING arg);

#ifdef DBG
INT Set_FixedRate_Proc(RTMP_ADAPTER *pAd, PSTRING arg);
#endif /* DBG */
#endif /* defined(RT2883) || defined(RT3883) || defined(RT3593) */
...
#ifdef RELEASE_EXCLUDE
#ifdef RTMP_MAC_USB
INT	Show_RxBulk_Proc(RTMP_ADAPTER *pAd, PSTRING arg);
INT	Show_TxBulk_Proc(RTMP_ADAPTER *pAd, PSTRING arg);
#endif /* RTMP_MAC_USB */
#endif /* RELEASE_EXCLUDE */
...
#ifdef RT305x
INT Set_HiPower_Proc(RTMP_ADAPTER *pAd, PSTRING arg);

#if defined(RT3352) || defined(RT5350)
#ifdef RTMP_INTERNAL_TX_ALC
INT Set_TSSIMaxRange_Proc(RTMP_ADAPTER *pAd, PSTRING arg);
...
#ifdef DYNAMIC_PWR_TABLE_MAPPED_BY_COUNTRY_REGION
INT RTMP_GetSingleSkuPathByCountryRegion(
    IN RTMP_ADAPTER *pAd,
    OUT CHAR *path,
    IN UINT32 path_len);
#endif /* DYNAMIC_PWR_TABLE_MAPPED_BY_COUNTRY_REGION */
