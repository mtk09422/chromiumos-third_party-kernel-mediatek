...
bool mtk_hdmi_dpi_set_out_color_format(struct mediatek_hdmi_dpi_context
				       *dpi_ctx,
...
bool mtk_hdmi_dpi_set_out_bit_num(struct mediatek_hdmi_dpi_context *dpi_ctx,
...
bool mtk_hdmi_dpi_set_out_yc_map(struct mediatek_hdmi_dpi_context *dpi_ctx,
...
bool mtk_hdmi_dpi_set_out_channel_swap(struct mediatek_hdmi_dpi_context *
				       dpi_ctx,
...
bool mtk_hdmi_dpi_power_off(struct mediatek_hdmi_dpi_context *dpi_ctx)
{
	if (!dpi_ctx->power_on) {
...
bool mtk_hdmi_dpi_power_on(struct mediatek_hdmi_dpi_context *dpi_ctx)
{
	if (dpi_ctx->power_on) {
	...
	clk_prepare_enable(dpi_ctx->tvd_clk);
...
bool mtk_hdmi_dpi_init(void *private_data)
{
	...
	mtk_hdmi_dpi_power_on(dpi_ctx);

	return true;
}

bool mtk_hdmi_dpi_set_display_mode(struct drm_display_mode *display_mode,
				   void *private_data)
{
	struct mediatek_hdmi_dpi_context *dpi_ctx = private_data;
