...
struct meidatek_hdmi_display_node *mtk_hdmi_display_create_node(
	...
	struct device_node *np, void *data)
{
	...
	display_node =
	    kzalloc(sizeof(struct meidatek_hdmi_display_node), GFP_KERNEL);
	if (!display_node) {
...
struct meidatek_hdmi_display_node *mtk_hdmi_display_find_node(struct device_node
							      *np)
{
...
static struct meidatek_hdmi_display_node *mtk_hdmi_display_get_pre_node(
	struct meidatek_hdmi_display_node *display_node)
{
...
static struct meidatek_hdmi_display_node *mtk_hdmi_display_get_next_node(
	struct meidatek_hdmi_display_node *display_node)
{
...
{
	struct meidatek_hdmi_display_node *node = display_node;
	struct meidatek_hdmi_display_node *pre_node = NULL;
	bool ret = true;
...
bool mtk_hdmi_display_set_vid_format(struct meidatek_hdmi_display_node *
				     display_node,
...
void mtk_hdmi_display_del_node(struct meidatek_hdmi_display_node *display_node)
{
