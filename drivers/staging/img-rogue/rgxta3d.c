	...
	*/
	...
	if(bKickTA)
	{
		...
		if (ui32NumFenceFds)
		{
			...
			*/
			eError =
			  pvr_sync_append_check_fences("TA",
			                               ui32NumFenceFds,
			                               ai32FenceFds,
			                               ui32NumUpdateSyncs,
			                               puiUpdateFWAddrs,
			...
			ui32NumUpdateSyncs = psFDCheckData->nr_updates;
			puiUpdateFWAddrs = psFDCheckData->update_ufo_addresses;
			pui32UpdateValues = psFDCheckData->update_values;
			ui32IntClientTAFenceCount = psFDCheckData->nr_checks;
			pauiIntClientTAFenceUFOAddress = psFDCheckData->check_ufo_addresses;
			paui32IntClientTAFenceValue = psFDCheckData->check_values;
		}
                       ...
                       IMG_BOOL                    bPDumpContinuous)
{
	...
	{
		eError =
		pvr_sync_append_update_fences("TA",
									  ui32NumFenceFDs,
									  paui32FenceFDs,
		...
		ui323DClientUpdateCount = psFDUpdateData->nr_updates;
		paui3DClientUpdateUFOAddress = psFDUpdateData->update_ufo_addresses;
		paui323DClientUpdateValue = psFDUpdateData->update_values;
		ui323DClientFenceCount = psFDUpdateData->nr_checks;
		paui3DClientFenceUFOAddress = psFDUpdateData->check_ufo_addresses;
		paui323DClientFenceValue = psFDUpdateData->check_values;
	}
#endif
