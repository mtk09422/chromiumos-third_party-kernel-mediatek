		...
		PVR_GPUTRACE_SWITCH_TYPE eSwType)
{
	...
	IMG_UINT64 ui64OSTimeStamp = OSClockns64();
	...
	ui32DVFSClock = psDevInfo->psGpuDVFSTable->aui32DVFSClock[psDevInfo->psGpuDVFSTable->ui32CurrentDVFSId];
	PVR_ASSERT(ui32DVFSClock>=1000000);

	{
		IMG_UINT64 deltaRgxTimer = ui64CRTimerStamp - psHWPerfPkt->ui64RGXTimer;	/* RGX CR timer ticks delta */
