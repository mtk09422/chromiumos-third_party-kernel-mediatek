...
/*WDT_MODE*/
#define MT65XX_WDT_MODE        0x00
#define MT65XX_WDT_MODE_KEY    0x22000000
#define MT65XX_WDT_MODE_AUTO_START (1 << 4)
#define MT65XX_WDT_MODE_EXTEN (1 << 2)
#define MT65XX_WDT_MODE_EN (1 << 0)
...
*/
#define MT65XX_WDT_LENGTH      0x04
#define MT65XX_WDT_LENGTH_KEY  0x08
#define MT65XX_WDT_LENGTH_FIELD_OFFSET  5
#define MT65XX_WDT_LENGTH_SECOND_TO_TICKS  64

/*WDT_RESTART*/
#define MT65XX_WDT_RESTART     0x08
#define MT65XX_WDT_RESTART_KEY 0x1971

#define MT65XX_WDT_SWRST		0x14
#define MT65XX_WDT_SWRST_KEY		0x1209
 ...
 * @wdt_notifier: notifier of system down and system halt
...
static int wdt_enable(struct watchdog_device *wdd)
{
	...
	wdt->wdd.ops->set_timeout(&wdt->wdd, wdt->wdd.timeout);

	tmp = MT65XX_WDT_MODE_KEY | MT65XX_WDT_MODE_AUTO_START
		    | MT65XX_WDT_MODE_EXTEN | MT65XX_WDT_MODE_EN;
